...
CORE_ETFS: List[ETFInfo] = [
    ...
    ETFInfo("510330", "沪深300ETF",    "华夏沪深300ETF",         "SSE",  "沪深300",   1),
    ETFInfo("510310", "沪深300ETF",    "易方达沪深300ETF",       "SSE",  "沪深300",   1),
    ETFInfo("159919", "沪深300ETF",    "嘉实沪深300ETF",         "SZSE", "沪深300",   2),
    # ═══ 上证50 ═══
    ETFInfo("510050", "上证50ETF",      "华夏上证50ETF",         "SSE",  "上证50",    1),
    # ═══ 中证500 ═══
    ETFInfo("510500", "中证500ETF",     "南方中证500ETF",        "SSE",  "中证500",   1),
    ETFInfo("159922", "中证500ETF",     "嘉实中证500ETF",         "SZSE", "中证500",   2),
    # ═══ 中证1000 ═══
